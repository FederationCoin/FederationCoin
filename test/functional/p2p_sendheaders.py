...
class SendHeadersTest(BitcoinTestFramework):
    ...
    def test_null_locators(self, test_node, inv_node):
        ...
        block = create_block(int(tip["hash"], 16), create_coinbase(tip["height"] + 1), tip["mediantime"] + 1, height=tip["height"] + 1)
        block.solve()
    ...
    def test_nonnull_locators(self, test_node, inv_node):
        ...
        for i in range(4):
            ...
            if i == 0:
                ...
                new_block = create_block(tip, create_coinbase(height + 1), block_time, height=height + 1)
                new_block.solve()
