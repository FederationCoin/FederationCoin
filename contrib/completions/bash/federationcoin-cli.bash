# Dynamic bash programmable completion for federationcoin-cli(1)
...
# call $federationcoin-cli for RPC
_bitcoin_rpc() {
...
_bitcoin_cli() {
    ...
    # save and use original argument to invoke federationcoin-cli for -help, help and RPC
    # as federationcoin-cli might not be in $PATH
    bitcoin_cli="$1"
...
complete -F _bitcoin_cli federationcoin-cli
