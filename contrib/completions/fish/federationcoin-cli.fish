...
complete --command federationcoin-cli --no-files
...
complete --command federationcoin-cli \
...
# Add commands
# Permit command completions after `federationcoin-cli help` but not after other commands
complete \
    --command federationcoin-cli \
    --no-files \
