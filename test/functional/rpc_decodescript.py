...
class DecodeScriptTest(BitcoinTestFramework):
    ...
    def decodescript_script_pub_key(self):
        ...
        assert_equal('gfcnrt1pfeesx0uu4l', rpc_result['address'])
    ...
    def decodescript_miniscript(self):
        ...
        assert res["segwit"]["desc"] == "addr(gfcnrt1q73qyfypp47hvgnkjqnav0j3k2lq3v76wg22dk8tmwuz5sfgv66xst0xgr5)#v67c77z6"
