...
complete --command federationcoind --no-files

# Extract options
function __fish_federationcoind_get_options
...
complete \
    --command federationcoind \
    --arguments "(__fish_federationcoind_get_options)"
# Enable file completions only if the commandline now contains a `*.=` style option
complete --command federationcoind \
...
complete \
    --command federationcoind \
    --arguments "(__fish_federationcoind_get_options --nofiles)"
