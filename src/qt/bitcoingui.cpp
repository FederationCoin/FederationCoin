...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Federation Coin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and federationcoin: URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Federation Coin addresses to prove you own them"));
    verifyMessageAction = new QAction(tr("&Verify message…"), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Federation Coin addresses"));
    ...
    openAction->setStatusTip(tr("Open a payment URI"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Federation Coin command-line options").arg(CLIENT_NAME));
