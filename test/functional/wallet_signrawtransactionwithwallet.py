...
class SignRawTransactionWithWalletTest(BitcoinTestFramework):
    ...
    def script_verification_error_test(self):
        ...
        privKeys = ['a7NE93KR4XnrBhv6JceggSmstZg4JzY2cfkUbv5DcX7BmSoCay67']
        ...
        scripts = [
            ...
            # Invalid script
            {'txid': '5b8673686910442c644b1f4993d8f7753c7c8fcb5c87ee40d56eaeef25204547', 'vout': 7,
             'scriptPubKey': 'badbadbadbad', 'amount': 1}
        ]
        ...
        # The historical pay-to-pubkey input cannot be signed on this chain, so all three inputs error.
        ...
        # The invalid script and the missing input are still reported.
        ...
        assert not rawTxSigned['errors'][1]['witness']
    ...
    def test_signing_with_missing_prevtx_info(self):
        ...
        for type in ["bech32", "p2sh-segwit", "legacy"]:
            ...
            # Unified sighash needs every spent output's amount, including legacy inputs.
