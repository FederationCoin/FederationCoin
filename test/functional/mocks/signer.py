...
def getdescriptors(args):
    xpub = "trB6nMbsSD2SBxuhNXhn4z1LDdKasWu6ENda7foJDVBd31u37KcqP9syhfEAfn5HgCiY6rxNjEhDYXuywbHJNZaEumJ3nkHfi9C2GGVfBBYBGEB"

    sys.stdout.write(json.dumps({
        "receive": [
            "pkh([00000001/44h/1h/" + args.account + "']" + xpub + "/0/*)#8mf8r0u2",
            "sh(wpkh([00000001/49h/1h/" + args.account + "']" + xpub + "/0/*))#f9sg793a",
            "wpkh([00000001/84h/1h/" + args.account + "']" + xpub + "/0/*)#esa8uhzc",
            "tr([00000001/86h/1h/" + args.account + "']" + xpub + "/0/*)#8hcrhgjq"
        ],
        "internal": [
            "pkh([00000001/44h/1h/" + args.account + "']" + xpub + "/1/*)#k0vx76vj",
            "sh(wpkh([00000001/49h/1h/" + args.account + "']" + xpub + "/1/*))#uy77x6yz",
            "wpkh([00000001/84h/1h/" + args.account + "']" + xpub + "/1/*)#gycxpzjq",
            "tr([00000001/86h/1h/" + args.account + "']" + xpub + "/1/*)#kraz2azc"
...
def displayaddress(args):
    ...
    expected_desc = {
        "wpkh([00000001/84h/1h/0h/0/0]02c97dc3f4420402e01a113984311bf4a1b8de376cac0bdcfaf1b3ac81f13433c7)#3te6hhy7": "gfcnrt1qm90ugl4d48jv8n6e5t9ln6t9zlpm5th6wlt4ts",
        "sh(wpkh([00000001/49h/1h/0h/0/0]02c97dc3f4420402e01a113984311bf4a1b8de376cac0bdcfaf1b3ac81f13433c7))#kz9y5w82": "2NS21K72mMEaZAZx6KzHtesjQRneUE74PCJ",
        "pkh([00000001/44h/1h/0h/0/0]02c97dc3f4420402e01a113984311bf4a1b8de376cac0bdcfaf1b3ac81f13433c7)#q3pqd8wh": "fZvftzPyGUggb62TnpUNFKWMSznDdLT12N",
